...
var app = angular.module('callbackApp', ['ui.mask']);
app.controller('callbackCtrl', function () {
	this.sended = false;
	this.order = {};
...
var page = $('.page'),
	...
	popup = {
		...
		open: function (popupName) {
			...
			$('body>*:not(.popup, .callback__widget)').addClass('blur');
		},
		openByHash: function () {
		...
		close: function (popup) {
			...
			$('body>*:not(.popup, .callback__widget)').removeClass('blur');
		}
	};
